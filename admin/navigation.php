<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <div <?php echo $page_title == "Index" ? "class='active'" : ""; ?>>
            <a class="navbar-brand" href="<?php echo $home_url; ?>admin">Home</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
            <ul class = "navbar-nav mr-auto">
                ...
                if (isset($_SESSION['type']) == 'Admin') {
                    ...
                    <li class = "nav-item" <?php echo $page_title == "Users" ? "class='active'" : ""; ?> >
                        <a class = "nav-link" href="<?php echo $home_url; ?>admin/read_users.php">Usuarios</a>
                    </li>
                    <?php
                }
                ?>
